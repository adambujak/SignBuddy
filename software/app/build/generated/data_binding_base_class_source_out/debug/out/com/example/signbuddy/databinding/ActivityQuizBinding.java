...
public final class ActivityQuizBinding implements ViewBinding {
  ...
  private ActivityQuizBinding(@NonNull ConstraintLayout rootView, @NonNull ListView listView) {
  ...
  public static ActivityQuizBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityQuizBinding((ConstraintLayout) rootView, listView);
    }
